...
class FnApproxAgent(object):
    ...
    values. Updates to the model are done using SARSA(lambda).
    """
    ...
    def train(self, function, discount_factor, lambda_value,
              start_learning_rate, end_learning_rate, start_epsilon,
        ...
        model_saving_interval -- Save the model info (i.e. write to file)
        ...
        while observation_number < total_observations:
            ...
            while True:
                ...
                function.update_model(
                    discount_factor, lambda_value, learning_rate, observation,
                ...
                if done:
                    ...
                    if episode_number % model_saving_interval == 0:
                        function.save()
