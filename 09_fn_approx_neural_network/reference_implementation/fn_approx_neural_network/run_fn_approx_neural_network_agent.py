...
# to it.
from fn_approx_neural_network.fn_approx_neural_network_agent import FnApproxAgent
...
if __name__ == "__main__":
    ...
    from fn_approx_neural_network.model_and_policy import NeuralNetwork
